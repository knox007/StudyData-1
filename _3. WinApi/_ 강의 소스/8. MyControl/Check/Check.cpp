...
LRESULT CALLBACK WndProc(HWND hWnd,UINT iMessage,WPARAM wParam,LPARAM lParam)
{
	...
	case WM_CREATE:
		chk2StateManual = CreateWindow(	TEXT("button"),
								TEXT("원 그리기?"),
								WS_CHILD | WS_VISIBLE | BS_CHECKBOX,		//	2가지 상태 수동
								20,20,160,25,
								hWnd,
								(HMENU)0,
								g_hInst,
		...
		chk2StateAuto = CreateWindow(	TEXT("button"),
								TEXT("종료 메시지 출력?"),
								WS_CHILD | WS_VISIBLE | BS_AUTOCHECKBOX,	//	2가지 상태 자동
								20,50,160,25,
								hWnd,
								(HMENU)1,
								g_hInst,
		...
		chk3StateManual = CreateWindow(	TEXT("button"),
								TEXT("3 State"),
								WS_CHILD | WS_VISIBLE | BS_3STATE,			//	3가지 상태 수동
								20,80,160,25,
								hWnd,
								(HMENU)2,
								g_hInst,
		...
		chk3StateAuto = CreateWindow(	TEXT("button"),
								TEXT("Auto 3 State"),
								WS_CHILD | WS_VISIBLE | BS_AUTO3STATE,		//	3가지 상태 자동
								20,110,160,25,
								hWnd,
								(HMENU)3,
								g_hInst,
