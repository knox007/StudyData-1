...
g_Param[3]={
	{10,10,180,50,"세 개의","스레드가 동시에","실행되고 있습니다",300},
	{210,10,180,50,"위치,","글자,","주기가 다릅니다",700},
	{410,10,180,50,"1번","2번","3번",800}
};
...
LRESULT CALLBACK WndProc(HWND hWnd,UINT iMessage,WPARAM wParam,LPARAM lParam)
{
	...
	case WM_CREATE:
		...
		// 세 개의 스레드를 만든다.
		for (i=0;i<3;i++)
			hThread[i]=CreateThread(NULL,0,ThreadFunc,&g_Param[i],0,&ThreadID[i]);
