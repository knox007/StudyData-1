...
public class Hole : MonoBehaviour {
    ...
    public void Open_Ing()
    {
        if (GoodMole == false)
        {
            _renderer.material.mainTexture = Open_Images[Ani_Count];
        }
        else
        {
            _renderer.material.mainTexture = Open_Images_2[Ani_Count];
        }
    ...
    public void Idle_Ing()
    {
        if (GoodMole == false)
        {
            _renderer.material.mainTexture = Idle_Images[Ani_Count];
        }
        else
        {
            _renderer.material.mainTexture = Idle_Images_2[Ani_Count];
        }
    ...
    public void Close_Ing()
    {
        if (GoodMole == false)
        {
            _renderer.material.mainTexture = Close_Images[Ani_Count];
        }
        else
        {
            _renderer.material.mainTexture = Close_Images_2[Ani_Count];
        }
    ...
    public void Catch_Ing()
    {
        if (GoodMole == false)
        {
            _renderer.material.mainTexture = Catch_Images[Ani_Count];
        }
        else
        {
            _renderer.material.mainTexture = Catch_Images_2[Ani_Count];
        }
        Ani_Count += 1;
