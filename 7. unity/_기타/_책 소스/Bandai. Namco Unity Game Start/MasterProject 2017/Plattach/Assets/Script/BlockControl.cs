...
public class BlockControl : MonoBehaviour {
	...
	void 	Awake()
	{
		...
		this.models[(int)Block.COLOR.GREEN]   = this.models_root.transform.Find("block_green").gameObject;
		this.models[(int)Block.COLOR.ORANGE]  = this.models_root.transform.Find("block_orange").gameObject;
		this.models[(int)Block.COLOR.YELLOW]  = this.models_root.transform.Find("block_yellow").gameObject;
		this.models[(int)Block.COLOR.MAGENTA] = this.models_root.transform.Find("block_purple").gameObject;
		this.models[(int)Block.COLOR.NECO]    = this.models_root.transform.Find("neco").gameObject;
