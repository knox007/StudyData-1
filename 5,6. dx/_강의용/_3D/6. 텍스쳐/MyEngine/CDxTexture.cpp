...
//========================================================
INT CDxTexture::Create(LPDIRECT3DDEVICE9 pDev, char* sFile, bool isPOW2, DWORD dwColor, DWORD dwFormat)
{
	m_pDev = pDev;
	...
	if (FAILED(D3DXCreateTextureFromFileEx(
		m_pDev
		, sFile
		, unWidth			//	Width	D3DX_DEFAULT_NONPOW2	D3DX_DEFAULT
		, unHeight			//	Height	D3DX_DEFAULT_NONPOW2	D3DX_DEFAULT
		, 1						//	MipLevels
		, 0						//	Usage
		, (D3DFORMAT)dwFormat	//	Format
