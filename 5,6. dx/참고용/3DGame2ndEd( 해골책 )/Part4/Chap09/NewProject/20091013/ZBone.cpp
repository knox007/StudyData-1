...
int	ZBone::Draw( D3DXMATRIX* pTM )
{
	...
	ZTBOXVERTEX vtx[8];
	vtx[0] = ZTBOXVERTEX( -1,  1,  1 , 0xffff0000 );		/// v0
	vtx[1] = ZTBOXVERTEX(  1,  1,  1 , 0xffff0000 );		/// v1
	vtx[2] = ZTBOXVERTEX(  1,  1, -1 , 0xffff0000 );		/// v2
	vtx[3] = ZTBOXVERTEX( -1,  1, -1 , 0xffff0000 );		/// v3
	vtx[4] = ZTBOXVERTEX( -1, -1,  1 , 0xffff0000 );		/// v4
	vtx[5] = ZTBOXVERTEX(  1, -1,  1 , 0xffff0000 );		/// v5
	vtx[6] = ZTBOXVERTEX(  1, -1, -1 , 0xffff0000 );		/// v6
	vtx[7] = ZTBOXVERTEX( -1, -1, -1 , 0xffff0000 );		/// v7
