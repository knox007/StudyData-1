...
#define WINDOW_W		500
#define WINDOW_H		500
#define WINDOW_TITLE	"Vertex Shader Tutorial"
...
{
	D3DXMATRIXA16	m;
	m = g_matWorld * g_matView * g_matProj;
	
	/// 행렬과 정점을 dp3연산하기때문에 전치행렬로 바꿔줘야 한다.
	D3DXMatrixTranspose( &m, &m );

	/// 행렬의 값을 정점쉐이더 상수테이블에 셋팅(c0 ~ c3)
	g_pd3dDevice->SetVertexShaderConstantF( 0, (float*)&m, 4 );
}
