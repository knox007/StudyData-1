...
ZTrack::ZTrack(float fFrameRate, Track &keys )
{
	int		i;
...
void ZTrack::_Get2Keys( float frame, std::vector<ZTKeyPos>& keys, ZTKeyPos*& k1, ZTKeyPos*& k2 )
{
	int		mkey;
	int		lkey = 0;
...
void ZTrack::_Get2Keys( float frame, std::vector<ZTKeyRot>& keys, ZTKeyRot*& k1, ZTKeyRot*& k2 )
{
	int		mkey;
	int		lkey = 0;
	int		rkey = keys.size()-1;
...
void ZTrack::_Get2Keys( float frame, std::vector<ZTKeyScl>& keys, ZTKeyScl*& k1, ZTKeyScl*& k2 )
{
	int		mkey;
	int		lkey = 0;
	int		rkey = keys.size()-1;
